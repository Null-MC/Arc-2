...
export function setupOptions() {
    ...
    let screen_Lighting = new Page('LIGHTING')
        ...
        .add(new Page('LIGHTING_SHADOWS')
            .add(asBool('LIGHTING_SHADOW_PCSS', true, true))
            .add(asBool('LIGHTING_SHADOW_EMISSION_MASK', true, true))
            .add(asBool('LIGHTING_SHADOW_BIN_ENABLED', true, true))
            .add(asIntRange('LIGHTING_SHADOW_MAX_COUNT', 64, 2, 128, 2, true))
            .add(asIntRange('LIGHTING_SHADOW_REALTIME', 0, 0, 8, 1, false))
    ...
    const screen_Post = new Page("POST")
        ...
        .add(new Page("POST_EXPOSURE")
            .add(asFloatRange("POST_EXPOSURE_MIN", -6.0, -8.0, 1.0, 0.5, false))
            .add(asFloatRange("POST_EXPOSURE_MAX", 28.0, 1.0, 64.0, 0.5, false))
