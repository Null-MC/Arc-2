...
const vec3 VL_WaterScatter = _RgbToLinear(vec3(0.5));
const vec3 VL_WaterTransmit = _RgbToLinear(1.0 - vec3(0.11, 0.68, 0.99));
const vec3 VL_WaterAmbient = 9.0*_RgbToLinear(vec3(0.325, 0.588, 0.439));
