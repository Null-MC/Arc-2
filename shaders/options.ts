...
export function setupOptions() {
    ...
    let screen_Lighting = new Page('LIGHTING')
        ...
        .add(new Page('LIGHTING_GI')
            ...
            .add(asInt("LIGHTING_GI_CASCADES", 1, 2, 3, 4).build(2))
    ...
    const screen_Effects = new Page("EFFECTS")
        ...
        .add(new Page("EFFECT_BLOOM")
            ...
            .add(asFloatRange("EFFECT_BLOOM_STRENGTH", 4.0, 0.0, 10.0, 0.05, false))
            .build())
    ...
    const screen_Post = new Page("POST")
        ...
        .add(new Page("POST_EXPOSURE")
            .add(asFloatRange("POST_EXPOSURE_MIN", -2.0, -8.0, 1.0, 0.5, false))
            .add(asFloatRange("POST_EXPOSURE_MAX", 18.0, 1.0, 64.0, 0.5, false))
