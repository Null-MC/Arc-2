float GetSkyDensity(const in vec3 localPos) {
    ...
    float ground_density = mix(0.0, 0.08, Scene_SkyPrecipitation);
    ground_density = mix(ground_density, 0.4, saturate(-nightF));
